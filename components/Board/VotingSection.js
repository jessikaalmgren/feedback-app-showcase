...
const VotingSection = () => {
  ...
  return (
    <div>
      <section className="pb-10 mb-10 pt-10 mt-[6.5rem] lg:w-full lg:pt-16 lg:flex-grow rounded-xl p-6 bg-[#EDE7F6] h-[550px] overflow-y-auto lg:overflow-visible lg:relative">
        <div className="flex items-center justify-center absolute top-[190px] lg:top-[-40px] left-1/2 lg:left-[188px] transform -translate-x-1/2 -translate-y-1/2">
